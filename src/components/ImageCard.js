      ...
      <div className="relative rounded-lg overflow-hidden mt-6 mr-0 md:mt-8 md:mr-4 shadow-md bg-gray-50 w-[22rem] h-[30rem] border border-gray-300">
        ...
        <div className="px-6 py-4">
          ...
          <ul className="text-gray-900">
            <li>
              <i
                className="fa-solid fa-heart fa-sm mr-1"
                style={{ color: "#c82828" }}
              ></i>
            ...
            <li>
              <i
                className="fa-solid fa-eye fa-xs mr-1"
                style={{ color: "#46b7ce" }}
              ></i>
            ...
            <li>
              <i
                className="fa-solid fa-download fa-sm mr-1.5"
                style={{ color: "#adadad" }}
              ></i>
        ...
        <div className="absolute bottom-0 left-0 px-6 py-4 space-y-2">
          {tags.map((tag, index) => (
            <span
              key={index}
              className="inline-block bg-gray-200 rounded-full px-3 py-1 text-xs font-medium text-gray-700 mr-1"
            >
              #{tag}
            </span>
          ))}
